...
class Shell(object):
    ...
    def get_client(self, args, debug=False):
        ...
        env_var_apikey = os.environ.get('ST2_API_KEY', None)
        cli_argument_apikey = getattr(args, 'apikey', None)
        if env_var_token or cli_argument_token or env_var_apikey or cli_argument_apikey:
            return client
